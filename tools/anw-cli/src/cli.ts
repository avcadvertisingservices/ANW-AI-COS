...
program
  .command("content")
  .description(
    "Inspect ANW AI-COS content system status, taxonomy, Recovery Library, and workflow.",
  )
  .option(
    "--status",
  ...
  .option(
    "--workflow",
    "Show the canonical ANW content lifecycle and publishing workflow without changing files.",
    false,
  )
  .action(
    (
