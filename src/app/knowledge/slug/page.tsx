          ...
          <div className="mx-auto max-w-7xl px-6 py-8 lg:px-10">
            <section className="rounded-3xl bg-[#0b4d3b] px-7 py-8 text-white shadow-lg lg:px-10">
              ...
              <p className="mt-4 max-w-3xl leading-7 text-emerald-50">
                ...
                sources, approval status and active review
                workflows.
              </p>
            ...
            libraryData.entries.length === 0 ? (
              <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-8 text-center">
                ...
                <p className="mt-2 text-sm text-slate-500">
                  Add a knowledge entry to Supabase to display
                  it here.
                </p>
              </div>
            ) : null}
...
function SidebarPlaceholder({
  ...
  return (
    <div className="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-emerald-50/80">
